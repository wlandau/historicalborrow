test_that("hb_summary_weighted() structure", {
  set.seed(0)
...
test_that("hb_summary_weighted() data summaries", {
  set.seed(0)
  data <- hb_sim_pool(
    n_continuous = 1,
    n_binary = 0,
...
test_that("hb_summary_weighted() pool mock mcmc", {
  set.seed(0)
  data <- hb_sim_pool(
    n_continuous = 1,
    n_binary = 0,
  ...
  mcmc <- head(mcmc, 6)
  mcmc_independent <- head(mcmc_independent, 6)
