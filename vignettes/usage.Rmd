...
mcmc_hierarchical <- hb_mcmc_hierarchical(
  ...
  # Can be continuous, categorical, or binary columns:
  covariates = c("factor1", "factor2"),
  # Choice of s_tau to approximate a given prior amount of borrowing.
  # Optional to use hb_s_tau() but not recommended in practice:
  s_tau = hb_s_tau(precision_ratio = 0.5, sigma = 1, n = 100),
  # Raise these arguments for serious analyses:
  n_chains = 4,
  n_adapt = 2e3,
  n_warmup = 2e3,
